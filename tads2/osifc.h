/* $Header: d:/cvsroot/tads/TADS2/osifc.h,v 1.3 1999/07/11 00:46:34 MJRoberts
 * Exp $ */
...
#ifdef WASMTADS
#error "Cannot use OS_PTHREAD_TLS with WASMTADS"
#endif
#include <pthread.h>
 ...
 */
void* os_find_next_file(void* ctx,
                        char* outbuf,
                        size_t outbufsiz,
                        int* isdir,
                        char* outpathbuf,
 ...
 */
int os_locate(const char* fname,
              int flen,
              const char* arg0,
              char* buf,
              size_t bufsiz);
 ...
 *.   [home] + [.mjr]deep.gam -> [home.mjr]deep.gam
 */
void os_build_full_path(char* fullpathbuf,
 ...
 *.    [home.mjr] + [-] -> [home.mjr.-]
 */
void os_combine_paths(char* fullpathbuf,
                      size_t pathbuflen,
                      const char* path,
                      const char* filename);
 ...
 */
int os_get_abs_filename(char* result_buf,
 ...
 */
int os_get_rel_path(char* result_buf,
                    size_t result_buf_size,
                    const char* basepath,
                    const char* filename);
 ...
 */
int os_is_file_in_dir(const char* filename,
                      const char* path,
                      int include_subdirs,
                      int match_self);
 ...
 */
void os_cvt_dir_url(char* result_buf,
                    size_t result_buf_size,
                    const char* src_path);
 ...
 */
void os_cvt_url_dir(char* result_buf,
                    size_t result_buf_size,
                    const char* src_url);
 ...
 */
int os_askfile(const char* prompt,
               char* fname_buf,
               int fname_buf_len,
               int prompt_type,
 ...
 */
int os_gets_timeout(unsigned char* buf,
                    size_t bufl,
 ...
 */
int os_get_event(unsigned long timeout_in_milliseconds,
                 int use_timeout,
 ...
 */
void* os_banner_create(void* parent,
                       int where,
                       void* other,
                       int wintype,
                       int align,
 ...
 *   is true.
 */
void os_banner_set_size(void* banner_handle,
                        int siz,
                        int siz_units,
                        int is_advisory);
